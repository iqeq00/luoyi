//package com.luoyi.example.mybatis.mysql;
//
...
//        pc.setParent("cn.laplacelab.common");
...
//
//        //自定义实体父类
////        strategy.setSuperEntityClass("com.mlrdky.framework.model.BaseModel");
//        //自定义 mapper 父类
////        strategy.setSuperMapperClass("com.mlrdky.framework.mapper.BaseMapper");
//        //自定义 controller 父类
//        strategy.setSuperControllerClass("cn.laplacelab.framework.controller.BaseController");
//        //自定义 service 实现类父类
////        strategy.setSuperServiceImplClass("com.mlrdky.framework.service.impl.BaseServiceImpl");
//        //自定义 service 接口父类
////        strategy.setSuperServiceClass("com.mlrdky.framework.service.BaseService");
//
//
//    }
//
...
//        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/laplacelab?useSSL=false&useUnicode=true&characterEncoding=UTF8&serverTimezone=GMT");
//        dataSourceConfig.setUsername("root");
////        dataSourceConfig.setPassword("lichee");
//        dataSourceConfig.setPassword("Lichee@323");
