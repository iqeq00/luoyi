...
/**
 * 和信通锦礼 调用 京东vop接口 - token
 */
//@Service
//@Slf4j
public class HXTTokenApi {

//    /**日志*/
    private static final Logger log = LoggerFactory.getLogger(HXTTokenApi.class);
...
//    JDJL("和乐关爱锦礼", "jd123456", "Jk59O7G1T9UiAs4G7aEc", "Kz3E4KsFLtAmLYYgHX4f","https://bizapi.jd.com"),
    ...
    public static void main(String[] args) {
        ...
        // 用户名
        String username = "和信通锦礼";
        params.put("username", username);
        // 加密后的密码
        String password = getMD5Str("jdjl123456");
        params.put("password", password);
        // 当前时间 格式yyyy-MM-dd HH:mm:ss
        String timestamp = DateFormatUtils.format(System.currentTimeMillis(), TIME_FORMAT);
        params.put("timestamp", timestamp);
        // 对接账号
        String clientId="nr190hagVLLtGwYHKdiG";
        params.put("client_id", clientId);
        // 对接账号密钥
        String clientSecret="NcQ6MHWgqbt1ukN3Dn4T";
        // 认证标识
