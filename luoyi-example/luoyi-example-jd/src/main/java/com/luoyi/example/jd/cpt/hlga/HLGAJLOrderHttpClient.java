...
public class HLGAJLOrderHttpClient {
    private static final Logger log = LoggerFactory.getLogger(HLGAJLOrderHttpClient.class);
...
//        log.info("配置:{}", JSON.toJSONString(config));
        ...
        return doPost("https://cvop.jd.com/component/http/JSON/youli/v1/order/getDetail",map);
    }
...
//        signParamMap.put("jdOrderId", "300365480819");
        signParamMap.put("jdOrderId", "299790608639");
