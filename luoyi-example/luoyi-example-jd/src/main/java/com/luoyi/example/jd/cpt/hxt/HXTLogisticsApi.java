...
/**
 * 和信通锦礼 调用 京东vop接口 - 7.10 查询配送信息
 */
public class HXTLogisticsApi {

    private static final Logger log = LoggerFactory.getLogger(HXTLogisticsApi.class);
    ...
    public static void getLogistics(String jdOrderId) {
        ...
        imap.put("token", "QNOE7FBUfm3yEMMIgV8sE38Ov");
    ...
    public static void main(String[] args) {
        String jdOrderId = "306785815361";
//        String jdOrderId = "300365480819";
